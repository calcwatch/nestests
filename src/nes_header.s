.import NES_MAPPER, NES_PRG_BANKS, NES_CHR_BANKS, NES_MIRRORING, NES_PRG_RAM, NES_BATTERY
...
.segment        "HEADER"
        ...
        .byte   <NES_MIRRORING | (<NES_BATTERY << 1) | (<NES_MAPPER << 4) ; ines mir  - Specifies VRAM mirroring of the banks, the mapper lower nibble, and battery backup present
        ...
        .byte   (<NES_PRG_RAM << 4)                     ; RAM size = 64 ** NES_PRG_RAM
        .byte   0,0,0,0                                 ; Unused settings
        .byte   $23                                     ; Uses Family BASIC keyboard
